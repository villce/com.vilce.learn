...
import com.vilce.annotation.model.vo.MyResult;
 ...
 * @Package: com.vilce.annotation.config.rateLimite.RateLimitAspect
 * @Author: 雷才哲
...
public class RateLimitAspect {
    ...
    @Pointcut("@annotation(com.vilce.annotation.config.rateLimite.RateLimit)")
