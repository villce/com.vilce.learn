 ...
 * @Package: com.vilce.common.autoconfig.web.WebProperties
 * @Author: 雷才哲
 * @Date: 2020/11/12 19:21
 * @Version: 1.0
 */
@ConfigurationProperties(prefix = "spring.vilce.web")
public class WebProperties {
     ...
     * 跨域配置
     */
    public CorsRegister cors = new CorsRegister();
