 ...
 * @Package: com.vilce.common.config.web.EmisOriginTrackedPropertiesLoader
 * @Author: 雷才哲
 * @Date: 2020/11/10 13:22
 * @Version: 1.0
 */
class VilceOriginTrackedPropertiesLoader {

    private final Resource resource;

    /**
     * Create a new {@link VilceOriginTrackedPropertiesLoader} instance.
     * @param resource the resource of the {@code .properties} data
     */
    VilceOriginTrackedPropertiesLoader(Resource resource) {
    ...
    Map<String, OriginTrackedValue> load(boolean expandLists) throws IOException {
        try (VilceOriginTrackedPropertiesLoader.CharacterReader reader = new VilceOriginTrackedPropertiesLoader.CharacterReader(this.resource)) {
    ...
    private String loadKey(StringBuilder buffer, VilceOriginTrackedPropertiesLoader.CharacterReader reader) throws IOException {
        buffer.setLength(0);
    ...
    private OriginTrackedValue loadValue(StringBuilder buffer, VilceOriginTrackedPropertiesLoader.CharacterReader reader, boolean splitLists)
            throws IOException {
        buffer.setLength(0);
