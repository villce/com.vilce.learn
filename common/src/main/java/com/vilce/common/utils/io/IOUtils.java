package com.vilce.common.utils.io;
...
public class IOUtils {
    ...
    public static boolean contentEquals(InputStream input1, InputStream input2) {
        try {
            ...
            throw new BasicException(ResultStatus.IO_EXCEPTION.getStatus(), "比较资源是否相等异常，" + e);
        }
    }
    ...
    public static byte[] toByteArray(final URI uri) {
        try {
            ...
            throw new BasicException(ResultStatus.IO_EXCEPTION.getStatus(), "资源转换为字节数组异常" + e);
        }
    }
    ...
    public static InputStream toBufferedInputStream(final InputStream input) {
        try {
            ...
            throw new BasicException(ResultStatus.IO_EXCEPTION.getStatus(), "资源相互转换异常，" + e);
        }
    }
    ...
    public static char[] toCharArray(final InputStream is, final Charset encoding) {
        try {
            ...
            throw new BasicException(ResultStatus.IO_EXCEPTION.getStatus(), "资源转换为字符数组异常" + e);
        }
    }
    ...
    public static LineIterator lineIterator(final InputStream input, final String encoding) {
        try {
            ...
            throw new BasicException(ResultStatus.IO_EXCEPTION.getStatus(), "获取输入流的迭代器异常，" + e);
        }
    }
    ...
    public static boolean readFully(final Reader input, final char[] buffer) {
        try {
            ...
            e.printStackTrace();
            LoggerUtils.error(IOUtils.class, "读取字符流异常：" + e.toString());
            return false;
        }
        return true;
    }
    ...
    public static void write(final byte[] data, final OutputStream output) {
        try {
            ...
            throw new BasicException(ResultStatus.IO_EXCEPTION.getStatus(), "将数据写入输出流异常，" + e);
        }
    }
