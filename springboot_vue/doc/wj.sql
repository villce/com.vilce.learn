...
(
    ...
    `name`      varchar(64)                                            DEFAULT NULL COMMENT '目录名',
    `name_zh`   varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '目录中文名',
    `icon_cls`  varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图标颜色',
    `component` varchar(64)                                            DEFAULT NULL COMMENT '前端控件名',
...
INSERT INTO `admin_menu`
VALUES ('8', '/admin/content/book', 'BookManagement', '图书管理', null, 'content/BookManagement', '4');
INSERT INTO `admin_menu`
...
INSERT INTO `admin_menu`
VALUES ('11', '/admin/content/wage', 'WageManagement', '工资管理', null, 'content/WageManagement', '4');
-- ----------------------------
...
(
    ...
    `desc_` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '权限描述',
    `url`   varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '权限地址',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8;
...
(
    ...
    `name_zh` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '角色中文名',
    `enabled` tinyint(1)                                              DEFAULT NULL COMMENT '角色状态：0-禁用，1-启用',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 10
  DEFAULT CHARSET = utf8;
...
(
    ...
    `mid` int(11) DEFAULT NULL COMMENT '目录id',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 194
  DEFAULT CHARSET = utf8
...
(
    `id`  int(20) NOT NULL AUTO_INCREMENT COMMENT '系统物理主键',
...
-- ----------------------------
INSERT INTO `book`
VALUES ('1', 'https://i.loli.net/2019/04/10/5cadaa0d0759b.jpg', '且在人间', '余秀华', '2019-2-1', '湖南文艺出版社',
        ...
        '2');
INSERT INTO `book`
VALUES ('2', 'https://i.loli.net/2019/04/10/5cada7e73d601.jpg', '三体', '刘慈欣', ' 2008-1', '重庆出版社',
        ...
        '2');
INSERT INTO `book`
VALUES ('32', 'https://i.loli.net/2019/04/10/5cada99bd8ca5.jpg', '叙事的虚构性', '[美] 海登·怀特 ', '2019-3', '南京大学出版社',
        ...
        '3');
INSERT INTO `book`
VALUES ('35', 'https://i.loli.net/2019/04/10/5cada940e206a.jpg', '圣母', '[日]秋吉理香子 ', '2019-3', '新星出版社',
        ...
        '1');
INSERT INTO `book`
VALUES ('37', 'https://i.loli.net/2019/04/10/5cada8986e13a.jpg', '奢侈与逸乐', '[英]马克辛·伯格', '2019-3', '中国工人出版社',
        '本书探讨了十八世纪英国新式、时尚的消费品的发明、制造和购买。', '3');
INSERT INTO `book`
VALUES ('38', 'https://i.loli.net/2019/04/10/5cada8b8a3a17.jpg', '忧伤动物', '[德]莫妮卡·马龙 ', '2019-4', '漓江出版社',
        '“忧伤动物”(animal triste)这个词组取自一句最早可以追溯到亚里士多德时代的拉丁语名言，即“欢爱后，每个动物都忧伤不已”（Post coitum omne animal triste est）。无疑，这部冠以如此标题的小说让人有不祥的预感并暗示着宿命的思想。小说的女主人公是位近乎百岁的老人。在多年前有意斩断了与外界的一切联系之后，在她的后半生里，她唯一能做的就是或躺或坐在“印着鲜红、艳绿和深紫色的大花”、让人想起“食肉植物的花朵”的床单上，追忆几十年前她和自己...',
        '1');
INSERT INTO `book`
VALUES ('54', 'https://i.loli.net/2019/04/10/5cada9d9d23a6.jpg', '爱界', '[英] 费伊·韦尔登 ', '2019-3-1', '人民文学出版社',
        ...
        '3');
INSERT INTO `book`
VALUES ('55', 'https://i.loli.net/2019/04/10/5cada824c7119.jpg', '密室中的旅行', '[美] 保罗·奥斯特 ', '2019-3', '九州出版社',
        ...
        '1');
INSERT INTO `book`
VALUES ('59', 'https://i.loli.net/2019/04/10/5cada87fd5c72.jpg', '基本穿搭', '[日]大山旬 ', '2019-3', '四川人民出版社',
        '对穿衣搭配感到不耐烦，认为时尚很麻烦，穿什么都可以或者对衣服有着自己的想法但不够自信，本书就是为这样的人而准备的穿衣指南。不需要追随瞬息万变的时尚潮流，也不需要烦恼色彩搭配，只要掌握最低限度的知识和备齐常规单品，谁都能完成清爽得体的 80分搭配。',
        '4');
INSERT INTO `book`
VALUES ('60', 'https://i.loli.net/2019/04/10/5cada976927da.jpg', '冒牌人生', '陈思安', '2019-4', '四川文艺出版社',
        '《冒牌人生》收录了十篇短篇小说。十个故事分别以城市中的怪人为主角，他们默默无闻地生存在城市主流生活的边缘地带：或是等待手术的性别认同障碍者，或是武艺高强而深藏不露的夜市摊主，或是卧底追凶的底层保安，或是甘于...',
        '1');
INSERT INTO `book`
VALUES ('61', 'https://i.loli.net/2019/04/10/5cada9202d970.jpg', '战争哀歌', '[越]保宁 ', '2019-4', '湖南文艺出版社',
        ...
        '1');
INSERT INTO `book`
VALUES ('62', 'https://i.loli.net/2019/04/10/5cada9c852298.jpg', '胡椒的全球史', '[美] 玛乔丽·谢弗 ', '2019-3', '上海三联出版社',
        ...
        '2');
INSERT INTO `book`
VALUES ('63', 'https://i.loli.net/2019/04/10/5cada962c287c.jpg', '与病对话', '胡冰霜', '2019-3-31', '北京联合出版公司',
        '一部融合科普性与趣味性、兼具心理学与哲学意味的医学散文。\n\n一位满怀仁心的资深医者对几十年行医生涯的回望与省思。\n\n全书以真实的病例和鲜活的故事贯穿始终，作者从一位全科医生、心理学者的视角观察、解读疾病与患者身心之关系，厘清大众对诸多常见疾病的误解...',
        '1');
INSERT INTO `book`
VALUES ('64', 'https://i.loli.net/2019/04/10/5cada858e6019.jpg', '上帝笑了99次', '[英]彼得·凯弗', '2019-2', '北京联合出版公司',
        ...
        '3');
INSERT INTO `book`
VALUES ('65', 'https://i.loli.net/2019/04/10/5cada8e1aa892.jpg', '互联网算法', '[美] 菲斯曼等 ', '2019-4', '江西人民出版社',
        '只要你租过房子、上网买过东西、自己经营过企业，那么你就处在商业变革的前线。在这场变革中，亚马逊、谷歌、优步等不同以往的企业取得了史无前例的成功，而促成这场变革的不只是科技进步，还有经济学思想。\n\n在这本趣味横生的书中，我们会看到，经济思想的革命远比科技革命更宏大。从谷歌广告的算法，到网上购物规避欺诈，都要依靠经济学家建立的经济模型，甚至连互联网公司...',
        '6');
INSERT INTO `book`
VALUES ('66', 'https://i.loli.net/2019/04/10/5cada9ec514c9.jpg', '七侯笔录', '马伯庸', '2019-4-15', '湖南文艺出版社',
        ...
        '3');
INSERT INTO `book`
VALUES ('67', 'https://i.loli.net/2019/04/10/5cada9870c2ab.jpg', '中心与边缘', '[美] 希尔斯', '2019-3', '译林出版社',
        ...
        '3');
INSERT INTO `book`
VALUES ('68', 'https://i.loli.net/2019/04/10/5cad643643d4c.jpg', '水浒群星闪耀时', '李黎', '2019-4', '上海文艺出版社',
        '本书以众所周知的梁山英雄为写作对象，重点书写其上山后、招安前的日常生活，涉及他们的喜怒哀乐、同类中人、乡愁怀旧、未来憧憬、命运追问等。书中涉及宋江、武松、鲁智深、李俊、燕青等等耳熟能详的人物而显得有些“改编”与水浒研究的意味，但鉴于所有人物皆为虚构，本书稿的内容是虚构之上的虚构，旨在宏大叙事的语境下突出个人的细微之处和命运感。',
        '1');
INSERT INTO `book`
VALUES ('69', 'https://i.loli.net/2019/04/10/5cad63931ce27.jpg', '谋杀狄更斯', '[美] 丹·西蒙斯 ', '2019-4', '上海文艺出版社',
        '“狄更斯的那场意外灾难发生在1865年6月9日，那列搭载他的成功、平静、理智、手稿与情妇的火车一路飞驰，迎向铁道上的裂隙，突然触目惊心地坠落了。”', '1');
...
(
    `id`   int(11)      NOT NULL COMMENT '系统物理主键',
...
(
    ...
    `article_label`        varchar(255) DEFAULT NULL COMMENT '文章标签（分号隔开）',
    `article_title`        varchar(255) DEFAULT NULL COMMENT '文章标题',
    `article_content_html` longtext CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '文章html',
    `article_content_md`   longtext CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '文章md',
    `article_abstract`     varchar(255) DEFAULT NULL COMMENT '文章描述',
    `article_cover`        varchar(255) DEFAULT NULL COMMENT '文章封面图片url',
    `article_date`         datetime     DEFAULT NULL COMMENT '编辑日期',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 14
  DEFAULT CHARSET = utf8
...
VALUES ('3', '文章', 'demo', '《白卷》项目简介',
        ...
        '白卷是一个简单的前后端分离项目，主要采用 Vue.js + SpringBoot 技术栈开发。', 'https://i.loli.net/2020/01/19/egDEfu5jXlJ6r3a.png',
        '2020-01-19 00:00:00');
...
(
    ...
    `order_time`                 datetime                                             NOT NULL COMMENT '单号时间',
    `basic_wage`                 double(10, 2)                                        NOT NULL COMMENT '基本工资',
    `job_wage`                   double(10, 2)                                        NOT NULL COMMENT '岗位工资',
    `benchmark_performance`      double(10, 2)                                        NOT NULL COMMENT '基准绩效',
    `standard_salary`            double(10, 2)                                        NOT NULL COMMENT '标准工资',
    `fixed_allowance`            double(10, 2) DEFAULT NULL COMMENT '固定津贴',
    `technical_expert_allowance` double(10, 2) DEFAULT NULL COMMENT '技术专家岗位津贴',
    `rank_allowance`             double(10, 2) DEFAULT NULL COMMENT '职级补贴',
    `fixed_bonus`                double(10, 2) DEFAULT NULL COMMENT '固定奖金',
    `floating_bonus`             double(10, 2) DEFAULT NULL COMMENT '浮动奖金',
    `total_wages`                double(10, 2)                                        NOT NULL COMMENT '工资共计',
    `examination_allowance`      double(10, 2) DEFAULT NULL COMMENT '考试津贴',
    `on_off_after_leave_pay`     double(10, 2)                                        NOT NULL COMMENT '入/离/事假后工资',
    `performance_adjustment`     double(10, 2) DEFAULT NULL COMMENT '绩效调整',
    `floating_allowance`         double(10, 2) DEFAULT NULL COMMENT '浮动津贴',
    `daily_overtime`             double(10, 2) DEFAULT NULL COMMENT '日常加班',
    `sick_leave_deduction`       double(10, 2) DEFAULT NULL COMMENT '病假扣除',
    `late_absentee_deductions`   double(10, 2) DEFAULT NULL COMMENT '迟到/旷工扣款',
    `other_increase_or_decrease` double(10, 2) DEFAULT NULL COMMENT '其他增减',
    `maternity_leave_deductions` double(10, 2) DEFAULT NULL COMMENT '产假扣款',
    `floating_bonus2`            double(10, 2) DEFAULT NULL COMMENT '浮动奖金2',
    `recommendation_award`       double(10, 2) DEFAULT NULL COMMENT '推荐奖',
    `product_experience_bonus`   double(10, 2) DEFAULT NULL COMMENT '产品体验/积分奖金',
    `payable`                    double(10, 2)                                        NOT NULL COMMENT '应发工资',
    `social_security`            double(10, 2)                                        NOT NULL COMMENT '社保',
    `provident_fund`             double(10, 2)                                        NOT NULL COMMENT '公积金',
    `post_insurance_pay`         double(10, 2)                                        NOT NULL COMMENT '险金后工资',
    `education_for_children`     double(10, 2) DEFAULT NULL COMMENT '子女教育',
    `home_loan`                  double(10, 2) DEFAULT NULL COMMENT '住房贷款',
    `housing_rent`               double(10, 2) DEFAULT NULL COMMENT '住房租金',
    `support_for_the_elderly`    double(10, 2) DEFAULT NULL COMMENT '赡养老人',
    `continuing_education`       double(10, 2) DEFAULT NULL COMMENT '继续教育',
    `deferred_insurance`         double(10, 2) DEFAULT NULL COMMENT '递延保险',
    `tax`                        double(10, 2)                                        NOT NULL COMMENT '本月个税',
    `paid_wages`                 double(10, 2)                                        NOT NULL COMMENT '实发工资',
...
-- Records of wage
-- ----------------------------
insert into `wage`(id, uid, username, code, order_time, basic_wage, job_wage, benchmark_performance, standard_salary,
...
values ('1', '1', 'lcz', '190665', '2019-8-15 00:00:00', 2500, 8700, 3800, 15000, 15000, 15000, 500,
        15500, 1575, 1050, 12875.00, 3000, 191.25, 12683.75);
