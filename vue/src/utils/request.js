...
const generateService = function (serverConfig) {
    let service = axios.create({
        baseURL: getServer(serverConfig), // url = base url + request url
...
const getServer = function (server) {
    if (location.href.indexOf('42.192.39.179') > -1) {
        return server.dev
...
export {vilceServiceApi, getServer, vilceServerConfig}
