<template>
  <div>
    ...
    <role-create @onSubmit="listRoles()" style="margin: 18px"></role-create>
...
<script>
import RoleCreate from '@/views/admin/user/RoleCreate'
import {addOrUpdateRole, getAllPermissions, listAllRolesInfo, updateRoleMenu} from "@/api/common/role";
import {get1RoleMenu} from "@/api/common/menu";
export default {
  name: 'UserRole',
